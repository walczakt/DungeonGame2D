...
public class DungeonInputHandler implements KeyListener {
    ...
    public void keyPressed(KeyEvent e) {
        switch (e.getKeyCode()) {
            //Thats the only thing I changed in this class, it only checks if player has a potion and executes heal method if so.
            case KeyEvent.VK_P: if(GameEngine.haspotion==true) {engine.heal();}; break;//added this line so the player may use his potion whenever he wants to
